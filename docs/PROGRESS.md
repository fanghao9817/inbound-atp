...
- 2026-09-10 ~14:10 PT: deploy #3 green end-to-end — SAM stack via GitHub OIDC (subject format `repo:owner@id/repo@id`), box roll-out, dbt on Postgres + Databricks, re-score + re-project. Every JD item now has a live, tested implementation.
